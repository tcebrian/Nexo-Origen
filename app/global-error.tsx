...
export default function GlobalError({
  ...
  return (
    <html lang="es">
      <body className="flex min-h-screen flex-col items-center justify-center bg-[#05030A] px-6 text-center text-white">
        <p className="text-[13px] font-medium text-red-300">
          Ha ocurrido un error inesperado
        </p>
        <p className="mt-2 max-w-md text-[12px] text-gray-400">
          Nexo Origen no ha podido cargar. Inténtalo de nuevo; si el problema
